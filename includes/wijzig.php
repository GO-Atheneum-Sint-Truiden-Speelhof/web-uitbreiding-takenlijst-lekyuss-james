...
<!-- Nakijken of form al is ingevuld of niet? 
Niet: info opvragen aan db adhv $_GET["id"]-->
			...
			<div class="col-md-6">
				<div class="form-group row">
					<div class="col">
						...
						<p><input type="text" id="UmakerN" class="form-control"name="UmakerN" value="<?php $row["NaamMaker"]; ?>"></p>
					</div>
				</div>
